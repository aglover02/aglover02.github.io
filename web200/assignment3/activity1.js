function mainShapeAreas() {
    ...
    document.write("The area of the rectangle is " + rectangleArea + " square feet.");
    ...
    document.write("The area of the triangle is " + triangleArea + " square feet.");

    //circle area
    let circleRadius = prompt("Enter the radius of the circle (in feet):");
    let circleArea = 3.14 * circleRadius * circleRadius;
    document.write("The area of the circle is " + circleArea + " square feet.");
}
